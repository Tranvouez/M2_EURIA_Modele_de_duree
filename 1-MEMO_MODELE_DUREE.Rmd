...
La p-value est élevée, la différence entre les lois de survie selon le traitemnet n'est donc pas significative. Au seuil de 5% la fonction de survie ne change pas selon le type d'évenement. 
...
Dans le summary, les hypothèses $H_0 : \beta_j=0$ sont testées.  Les quantités $Pr(>|z|)$ sont $P(|U|> z)$, avec $U$ de loi normale $ N(0,1)$.
